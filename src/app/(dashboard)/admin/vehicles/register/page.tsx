                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between pb-3 border-b border-slate-800">
                      <div>
                        <span className={`text-xs font-mono font-bold px-2.5 py-1 rounded-lg uppercase ${item.status === 'Ativo' || !item.status ? 'bg-green-500/10 border border-green-500/20 text-green-400' : 'bg-amber-500/10 border border-amber-500/20 text-amber-400'}`}>
                          {item.plate}
                        </span>
